...
SECRET_KEY = 'django-insecure-8(eg2j$0e2d7ls)9yc1jrnia#fggjakvlg8#951t^tf3l14*pv'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'MusicSite-database',  # database name
...
AUTH_USER_MODEL = 'MusicApp.MyMusicAppUser'